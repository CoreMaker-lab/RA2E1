...
#define VECTOR_NUMBER_GPT5_CAPTURE_COMPARE_B ((IRQn_Type) 13) /* GPT5 CAPTURE COMPARE B (Capture/Compare match B) */
#define GPT5_CAPTURE_COMPARE_B_IRQn          ((IRQn_Type) 13) /* GPT5 CAPTURE COMPARE B (Capture/Compare match B) */
#ifdef __cplusplus
        }
        #endif
#endif /* VECTOR_DATA_H */
