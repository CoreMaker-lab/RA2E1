...
***********************************************************************************************************************/
/***********************************************************************************************************************
* Touch I/F Configuration File  : RA2E1_Project21.tifcfg
* Tuning Log File               : RA2E1_Project21_log_tuning20250303235917.log
***********************************************************************************************************************/
...
{
    { .ssdiv = CTSU_SSDIV_4000, .so = 0x0C2, .snum = 0x07, .sdpa = 0x0F },
    { .ssdiv = CTSU_SSDIV_4000, .so = 0x0D0, .snum = 0x07, .sdpa = 0x0F },
};
